...
def calculate_error(m, b, point):
  x_point = point[0]
  y_point = point[1]
  diff = abs(get_y(m, b, x_point) - y_point)
  return diff
...
# Tasks 11 and 12
#interating through all possible lines to find which line has the least error aka best fit line
...
# Task 13
#predict how high the ball will bounce when x(width of ball) = 6
